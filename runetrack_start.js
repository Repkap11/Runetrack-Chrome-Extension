...
function interceptRequest(request) {
  console.error('onBeforeRequest ', request.url);
  if (request && request.url && request.url === 'http://runetrack.com/images/banner_text.png') {
    return { redirectUrl: 'https://www.google.com/images/srpr/logo11w.png' }
  }
}
chrome.webRequest.onBeforeRequest.addListener(interceptRequest, null, ['blocking']);
console.error("Listener set");
